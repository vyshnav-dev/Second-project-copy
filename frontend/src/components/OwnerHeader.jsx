                        ...
                        <Nav className="ms-auto">
                            {ownerInfo ? (
                                <>
                                    ...
                                    <Col xs={6} md={4}>
                                        <Image style={{ width: "50px", marginRight: "-94px" }} src= { ownerInfo.image ?`https://second-project-copy.onrender.com/Images/${ownerInfo.image}`:'https://cdn.vectorstock.com/i/preview-1x/99/94/default-avatar-placeholder-profile-icon-male-vector-23889994.jpg'} roundedCircle />
                                    </Col>
