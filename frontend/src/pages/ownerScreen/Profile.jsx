...
const Profile = () => {
  ...
  return (
    ...
    <FormContainer style={{marginTop:'5rem'}} className="form-container">
      <div>
      <h1 style={{color:'blue', textAlign:'center'}}> Owner Profile</h1>
      </div>
      
      <div style={{display:'flex',justifyContent:'center',marginTop:'20px'}}>
        <Image style={{width:"90px",marginRight:"10px"}} src= { ownerInfo.image ?`https://second-project-copy.onrender.com/Images/${ownerInfo.image}`:'https://cdn.vectorstock.com/i/preview-1x/99/94/default-avatar-placeholder-profile-icon-male-vector-23889994.jpg'} roundedCircle />
        </div>
